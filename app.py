...
def extract_details(text):
    """Extract multiple people details using Gemini."""
    prompt = (
    ...
    try:
        ...
        details_list = json.loads(data[start:end].replace("'", '"'))
...
def incoming_message():
    ...
    resp.message(f"✅ {len(people)} candidate(s) details stored successfully.")
    return str(resp)
